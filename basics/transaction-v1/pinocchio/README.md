...
From this directory (`basics/transaction-v1/pinocchio/`):

```bash
cargo build-sbf --manifest-path=./program/Cargo.toml
```

This writes the program binary to `target/deploy/transaction_v1_pinocchio_program.so`.
