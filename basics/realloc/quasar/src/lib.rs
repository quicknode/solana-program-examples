...
mod quasar_realloc {
    ...
    pub fn initialize(ctx: Ctx<InitializeAccountConstraints>, message: String<1024, 2>) -> Result<(), ProgramError> {
    ...
    pub fn update(ctx: Ctx<UpdateAccountConstraints>, message: String<1024, 2>) -> Result<(), ProgramError> {
