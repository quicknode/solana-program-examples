...
mod quasar_pda_rent_payer {
    ...
    pub fn init_rent_vault(ctx: Ctx<InitRentVaultAccountConstraints>, fund_lamports: u64) -> Result<(), ProgramError> {
    ...
    pub fn create_new_account(ctx: Ctx<CreateNewAccountAccountConstraints>) -> Result<(), ProgramError> {
