...
mod quasar_abl_token {
    ...
    pub fn init_mint(
        ctx: Ctx<InitMintAccountConstraints>,
        decimals: u8,
        freeze_authority: [u8; 32],
        permanent_delegate: [u8; 32],
        transfer_hook_authority: [u8; 32],
    ...
    pub fn init_config(ctx: Ctx<InitConfigAccountConstraints>) -> Result<(), ProgramError> {
    ...
    pub fn attach_to_mint(ctx: Ctx<AttachToMintAccountConstraints>) -> Result<(), ProgramError> {
    ...
    pub fn tx_hook(ctx: Ctx<TxHookAccountConstraints>, amount: u64) -> Result<(), ProgramError> {
    ...
    pub fn remove_wallet(ctx: Ctx<RemoveWalletAccountConstraints>) -> Result<(), ProgramError> {
