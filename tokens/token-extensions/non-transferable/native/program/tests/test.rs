use {
    ...
    token_2022_non_transferable_program::CreateTokenArgs,
};

const RENT_SYSVAR_ID: Pubkey = pubkey!("SysvarRent111111111111111111111111111111111");

#[test]
fn test_create_non_transferable_token() {
    ...
    let program_bytes =
        include_bytes!("../../../../../../target/deploy/token_2022_non_transferable_program.so");
