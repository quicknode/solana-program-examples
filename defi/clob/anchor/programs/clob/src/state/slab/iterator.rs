...
//
// Trimmed: this iterator yields handles + leaf refs only (no oracle peg
// validity filtering). That's all the matching engine needs — fills cross in
// pure price-time priority, and there are no time-in-force or peg checks to
// apply.
