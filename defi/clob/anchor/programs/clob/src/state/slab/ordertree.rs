...
//
// Trimmed from the upstream ordertree.rs:
//   - dropped expiry tracking (no time-in-force orders here)
//   - dropped `remove_one_expired` / `find_earliest_expiry`
//   - error type rebased to this crate's `ErrorCode`
