...
mod quasar_asset_leasing {
    ...
    pub fn create_lease(
        context: Ctx<CreateLeaseAccountConstraints>,
        lease_id: u64,
        leased_amount: u64,
    ...
    pub fn take_lease(context: Ctx<TakeLeaseAccountConstraints>) -> Result<(), ProgramError> {
        instructions::handle_take_lease(&mut context.accounts)
    }

    #[instruction(discriminator = 2)]
    pub fn pay_lease_fee(context: Ctx<PayLeaseFeeAccountConstraints>) -> Result<(), ProgramError> {
        instructions::handle_pay_lease_fee(&mut context.accounts)
    }

    #[instruction(discriminator = 3)]
    pub fn top_up_collateral(
        context: Ctx<TopUpCollateralAccountConstraints>,
        amount: u64,
    ) -> Result<(), ProgramError> {
    ...
    pub fn return_lease(context: Ctx<ReturnLeaseAccountConstraints>) -> Result<(), ProgramError> {
        instructions::handle_return_lease(&mut context.accounts)
    }

    #[instruction(discriminator = 5)]
    pub fn liquidate(context: Ctx<LiquidateAccountConstraints>) -> Result<(), ProgramError> {
        instructions::handle_liquidate(&mut context.accounts)
    }

    #[instruction(discriminator = 6)]
    pub fn close_expired(context: Ctx<CloseExpiredAccountConstraints>) -> Result<(), ProgramError> {
