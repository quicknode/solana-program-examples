...
pub mod asset_leasing {
    ...
    pub fn take_lease(context: Context<TakeLeaseAccountConstraints>) -> Result<()> {
    ...
    pub fn pay_lease_fee(context: Context<PayLeaseFeeAccountConstraints>) -> Result<()> {
    ...
    pub fn top_up_collateral(context: Context<TopUpCollateralAccountConstraints>, amount: u64) -> Result<()> {
    ...
    pub fn return_lease(context: Context<ReturnLeaseAccountConstraints>) -> Result<()> {
    ...
    pub fn close_expired(context: Context<CloseExpiredAccountConstraints>) -> Result<()> {
