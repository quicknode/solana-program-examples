...
_Solana program examples ('smart contracts') in Anchor 1, Anchor 2, Quasar, Pinocchio, native Rust, and sBPF assembly. Focused on financial software, plus the basics, tokens, Token Extensions, state compression, and more._
...
- Every example builds and passes CI on the latest Anchor 1, the Anchor 2 release candidate, and Quasar.
...
[![Anchor v1](../../actions/workflows/anchor-v1.yml/badge.svg)](../../actions/workflows/anchor-v1.yml) [![Anchor v2](../../actions/workflows/anchor.yml/badge.svg)](../../actions/workflows/anchor.yml) [![Quasar](../../actions/workflows/quasar.yml/badge.svg)](../../actions/workflows/quasar.yml) [![Pinocchio](../../actions/workflows/pinocchio.yml/badge.svg)](../../actions/workflows/pinocchio.yml) [![Native](../../actions/workflows/native.yml/badge.svg)](../../actions/workflows/native.yml) [![ASM](../../actions/workflows/solana-asm.yml/badge.svg)](../../actions/workflows/solana-asm.yml)

Each example is available in one or more of the following frameworks:

- [⚓ Anchor v1](https://www.anchor-lang.com/) - the most popular framework for Solana development, in its current major version. Lives in `anchor-v1/`. Install with `avm install 1.2.0 && avm use 1.2.0`, build with `anchor build`, test with `anchor test`.
- [⚓ Anchor v2](https://www.anchor-lang.com/) - the next major version of Anchor, a ground-up rewrite that is not yet released. Lives in `anchor/`, alongside the v1 copy of the same example, and builds on the release candidate: install with `cargo install anchor-cli --version 2.0.0-rc.1 --locked`, then the same `anchor build` / `anchor test`.
...
[⚓ Anchor v1](./finance/escrow/anchor-v1) [⚓ Anchor v2](./finance/escrow/anchor) [💫 Quasar](./finance/escrow/quasar) [🦀 Native](./finance/escrow/native)
...
[⚓ Anchor v1](./finance/lending/anchor-v1) [⚓ Anchor v2](./finance/lending/anchor) [💫 Quasar](./finance/lending/quasar)
...
[⚓ Anchor v1](./finance/order-book/anchor-v1) [⚓ Anchor v2](./finance/order-book/anchor) [💫 Quasar](./finance/order-book/quasar)
...
[⚓ Anchor v1](./finance/token-swap/anchor-v1) [⚓ Anchor v2](./finance/token-swap/anchor) [💫 Quasar](./finance/token-swap/quasar)
...
[⚓ Anchor v1](./finance/betting-market/anchor-v1) [⚓ Anchor v2](./finance/betting-market/anchor) [💫 Quasar](./finance/betting-market/quasar)
...
[⚓ Anchor v1](./finance/options/anchor-v1) [⚓ Anchor v2](./finance/options/anchor) [💫 Quasar](./finance/options/quasar)
...
[⚓ Anchor v1](./basics/hello-solana/anchor-v1) [⚓ Anchor v2](./basics/hello-solana/anchor) [💫 Quasar](./basics/hello-solana/quasar) [🤥 Pinocchio](./basics/hello-solana/pinocchio) [🦀 Native](./basics/hello-solana/native) [🧬 ASM](./basics/hello-solana/asm)

### Account Data

Store and retrieve data using Solana accounts.

[⚓ Anchor v1](./basics/account-data/anchor-v1) [⚓ Anchor v2](./basics/account-data/anchor) [💫 Quasar](./basics/account-data/quasar) [🤥 Pinocchio](./basics/account-data/pinocchio) [🦀 Native](./basics/account-data/native)
...
[⚓ Anchor v1](./basics/counter/anchor-v1) [⚓ Anchor v2](./basics/counter/anchor) [💫 Quasar](./basics/counter/quasar) [🤥 Pinocchio](./basics/counter/pinocchio) [🦀 Native](./basics/counter/native)

### Favorites

Save and update per-user state, ensuring users can only modify their own data.

[⚓ Anchor v1](./basics/favorites/anchor-v1) [⚓ Anchor v2](./basics/favorites/anchor) [💫 Quasar](./basics/favorites/quasar) [🤥 Pinocchio](./basics/favorites/pinocchio) [🦀 Native](./basics/favorites/native)
...
[⚓ Anchor v1](./basics/checking-accounts/anchor-v1) [⚓ Anchor v2](./basics/checking-accounts/anchor) [💫 Quasar](./basics/checking-accounts/quasar) [🤥 Pinocchio](./basics/checking-accounts/pinocchio) [🦀 Native](./basics/checking-accounts/native) [🧬 ASM](./basics/checking-accounts/asm)

### Close Account

Close an account and reclaim its [lamports](https://solana.com/docs/terminology#lamport).

[⚓ Anchor v1](./basics/close-account/anchor-v1) [⚓ Anchor v2](./basics/close-account/anchor) [💫 Quasar](./basics/close-account/quasar) [🤥 Pinocchio](./basics/close-account/pinocchio) [🦀 Native](./basics/close-account/native)

### Create Account

Create new accounts on the blockchain.

[⚓ Anchor v1](./basics/create-account/anchor-v1) [⚓ Anchor v2](./basics/create-account/anchor) [💫 Quasar](./basics/create-account/quasar) [🤥 Pinocchio](./basics/create-account/pinocchio) [🦀 Native](./basics/create-account/native) [🧬 ASM](./basics/create-account/asm)

### Cross-Program Invocation

Call one program from another - the hand program invokes the lever program to toggle a switch.

[⚓ Anchor v1](./basics/cross-program-invocation/anchor-v1) [⚓ Anchor v2](./basics/cross-program-invocation/anchor) [💫 Quasar](./basics/cross-program-invocation/quasar) [🦀 Native](./basics/cross-program-invocation/native)

### PDA Rent Payer

Use a PDA to pay [rent](https://solana.com/docs/terminology#rent) for creating a new account.

[⚓ Anchor v1](./basics/pda-rent-payer/anchor-v1) [⚓ Anchor v2](./basics/pda-rent-payer/anchor) [💫 Quasar](./basics/pda-rent-payer/quasar) [🤥 Pinocchio](./basics/pda-rent-payer/pinocchio) [🦀 Native](./basics/pda-rent-payer/native)

### Processing Instructions

Add parameters to an [instruction handler](https://solana.com/docs/terminology#instruction-handler) and use them.

[⚓ Anchor v1](./basics/processing-instructions/anchor-v1) [⚓ Anchor v2](./basics/processing-instructions/anchor) [💫 Quasar](./basics/processing-instructions/quasar) [🤥 Pinocchio](./basics/processing-instructions/pinocchio) [🦀 Native](./basics/processing-instructions/native)

### Program Derived Addresses

Store and retrieve state using PDAs as deterministic account addresses.

[⚓ Anchor v1](./basics/program-derived-addresses/anchor-v1) [⚓ Anchor v2](./basics/program-derived-addresses/anchor) [💫 Quasar](./basics/program-derived-addresses/quasar) [🤥 Pinocchio](./basics/program-derived-addresses/pinocchio) [🦀 Native](./basics/program-derived-addresses/native)

### Realloc

Handle accounts that need to grow or shrink in size.

[⚓ Anchor v1](./basics/realloc/anchor-v1) [⚓ Anchor v2](./basics/realloc/anchor) [💫 Quasar](./basics/realloc/quasar) [🤥 Pinocchio](./basics/realloc/pinocchio) [🦀 Native](./basics/realloc/native)

### Rent

Calculate an account's size to determine the minimum rent-exempt balance.

[⚓ Anchor v1](./basics/rent/anchor-v1) [⚓ Anchor v2](./basics/rent/anchor) [💫 Quasar](./basics/rent/quasar) [🤥 Pinocchio](./basics/rent/pinocchio) [🦀 Native](./basics/rent/native)

### Repository Layout

Structure a larger Solana program across multiple files and modules.

[⚓ Anchor v1](./basics/repository-layout/anchor-v1) [⚓ Anchor v2](./basics/repository-layout/anchor) [💫 Quasar](./basics/repository-layout/quasar) [🦀 Native](./basics/repository-layout/native)
...
[⚓ Anchor v1](./basics/pyth/anchor-v1) [⚓ Anchor v2](./basics/pyth/anchor) [💫 Quasar](./basics/pyth/quasar)
...
[⚓ Anchor v1](./tokens/create-token/anchor-v1) [⚓ Anchor v2](./tokens/create-token/anchor) [💫 Quasar](./tokens/create-token/quasar) [🦀 Native](./tokens/create-token/native)

### Mint NFT

Mint an NFT from inside your own program using the Token and Metaplex Token Metadata programs.

[⚓ Anchor v1](./tokens/nft-minter/anchor-v1) [⚓ Anchor v2](./tokens/nft-minter/anchor) [💫 Quasar](./tokens/nft-minter/quasar) [🦀 Native](./tokens/nft-minter/native)

### NFT Operations

Create an NFT collection, mint NFTs, and verify NFTs as part of a collection using Metaplex Token Metadata.

[⚓ Anchor v1](./tokens/nft-operations/anchor-v1) [⚓ Anchor v2](./tokens/nft-operations/anchor) [💫 Quasar](./tokens/nft-operations/quasar)

### Token Minter

Mint tokens from inside your own program using the [Classic Token Program](https://solana.com/docs/terminology#token-program).

[⚓ Anchor v1](./tokens/token-minter/anchor-v1) [⚓ Anchor v2](./tokens/token-minter/anchor) [💫 Quasar](./tokens/token-minter/quasar) [🦀 Native](./tokens/token-minter/native)

### Transfer Tokens

Transfer tokens between accounts.

[⚓ Anchor v1](./tokens/transfer-tokens/anchor-v1) [⚓ Anchor v2](./tokens/transfer-tokens/anchor) [💫 Quasar](./tokens/transfer-tokens/quasar) [🦀 Native](./tokens/transfer-tokens/native)

### PDA Mint Authority

Mint tokens using a PDA as the mint authority, so your program controls token issuance.

[⚓ Anchor v1](./tokens/pda-mint-authority/anchor-v1) [⚓ Anchor v2](./tokens/pda-mint-authority/anchor) [💫 Quasar](./tokens/pda-mint-authority/quasar) [🦀 Native](./tokens/pda-mint-authority/native)

### External Delegate Token Master

Control token transfers using an external secp256k1 delegate signature.

[⚓ Anchor v1](./tokens/external-delegate-token-master/anchor-v1) [⚓ Anchor v2](./tokens/external-delegate-token-master/anchor) [💫 Quasar](./tokens/external-delegate-token-master/quasar)
...
[⚓ Anchor v1](./tokens/token-extensions/basics/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/basics/anchor) [💫 Quasar](./tokens/token-extensions/basics/quasar)
...
[⚓ Anchor v1](./tokens/token-extensions/cpi-guard/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/cpi-guard/anchor) [💫 Quasar](./tokens/token-extensions/cpi-guard/quasar)

### Default Account State

Create new [token accounts](https://solana.com/docs/terminology#token-account) that are frozen by default.

[⚓ Anchor v1](./tokens/token-extensions/default-account-state/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/default-account-state/anchor) [💫 Quasar](./tokens/token-extensions/default-account-state/quasar) [🦀 Native](./tokens/token-extensions/default-account-state/native)

### Group Pointer

Create tokens that belong to larger groups using the Group Pointer extension.

[⚓ Anchor v1](./tokens/token-extensions/group/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/group/anchor) [💫 Quasar](./tokens/token-extensions/group/quasar)

### Immutable Owner

Create token accounts whose owning program cannot be changed.

[⚓ Anchor v1](./tokens/token-extensions/immutable-owner/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/immutable-owner/anchor) [💫 Quasar](./tokens/token-extensions/immutable-owner/quasar)

### Interest Bearing Tokens

Create tokens that show an interest calculation, updating their displayed balance over time.

[⚓ Anchor v1](./tokens/token-extensions/interest-bearing/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/interest-bearing/anchor) [💫 Quasar](./tokens/token-extensions/interest-bearing/quasar)

### Memo Transfer

Require all transfers to include a descriptive memo.

[⚓ Anchor v1](./tokens/token-extensions/memo-transfer/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/memo-transfer/anchor) [💫 Quasar](./tokens/token-extensions/memo-transfer/quasar)
...
[⚓ Anchor v1](./tokens/token-extensions/metadata/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/metadata/anchor)
...
[⚓ Anchor v1](./tokens/token-extensions/nft-meta-data-pointer/anchor-example/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/nft-meta-data-pointer/anchor-example/anchor)

### Mint Close Authority

Allow a designated account to close a token mint.

[⚓ Anchor v1](./tokens/token-extensions/mint-close-authority/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/mint-close-authority/anchor) [💫 Quasar](./tokens/token-extensions/mint-close-authority/quasar) [🦀 Native](./tokens/token-extensions/mint-close-authority/native)
...
[⚓ Anchor v1](./tokens/token-extensions/non-transferable/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/non-transferable/anchor) [💫 Quasar](./tokens/token-extensions/non-transferable/quasar) [🦀 Native](./tokens/token-extensions/non-transferable/native)

### Permanent Delegate

Create tokens that remain under the control of a designated account, even when transferred elsewhere.

[⚓ Anchor v1](./tokens/token-extensions/permanent-delegate/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/permanent-delegate/anchor) [💫 Quasar](./tokens/token-extensions/permanent-delegate/quasar)

### Transfer Fee

Create tokens with a built-in transfer fee.

[⚓ Anchor v1](./tokens/token-extensions/transfer-fee/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-fee/anchor) [💫 Quasar](./tokens/token-extensions/transfer-fee/quasar) [🦀 Native](./tokens/token-extensions/transfer-fee/native)

### Transfer Hook - Hello World

A minimal transfer hook that executes custom logic on every token transfer.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/hello-world/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/hello-world/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/hello-world/quasar)

### Transfer Hook - Counter

Count how many times tokens have been transferred.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/counter/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/counter/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/counter/quasar)

### Transfer Hook - Account Data as Seed

Use token account owner data as seeds to derive extra accounts in a transfer hook.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/account-data-as-seed/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/account-data-as-seed/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/account-data-as-seed/quasar)

### Transfer Hook - Allow/Block List

Restrict or allow token transfers using an onchain list managed by a list authority.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/allow-block-list-token/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/allow-block-list-token/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/allow-block-list-token/quasar)

### Transfer Hook - Transfer Cost

Charge an additional fee on every token transfer.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/transfer-cost/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/transfer-cost/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/transfer-cost/quasar)

### Transfer Hook - Transfer Switch

Enable or disable token transfers with an onchain switch.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/transfer-switch/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/transfer-switch/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/transfer-switch/quasar)

### Transfer Hook - Whitelist

Restrict transfers so only whitelisted accounts can receive tokens.

[⚓ Anchor v1](./tokens/token-extensions/transfer-hook/whitelist/anchor-v1) [⚓ Anchor v2](./tokens/token-extensions/transfer-hook/whitelist/anchor) [💫 Quasar](./tokens/token-extensions/transfer-hook/whitelist/quasar)
...
[⚓ Anchor v1](./compression/cnft-burn/anchor-v1) [⚓ Anchor v2](./compression/cnft-burn/anchor) [💫 Quasar](./compression/cnft-burn/quasar)

### cNFT Vault

Store Metaplex compressed NFTs inside a PDA.

[⚓ Anchor v1](./compression/cnft-vault/anchor-v1) [⚓ Anchor v2](./compression/cnft-vault/anchor) [💫 Quasar](./compression/cnft-vault/quasar)

### Compression Utilities

Work with Metaplex compressed NFTs.

[⚓ Anchor v1](./compression/cutils/anchor-v1) [⚓ Anchor v2](./compression/cutils/anchor) [💫 Quasar](./compression/cutils/quasar)
