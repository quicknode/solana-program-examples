...
them in one place no single bettor controls, and paying winners by a fixed, public formula. (Outcome
resolution is still trusted: the admin chooses the winning outcome, as described below.) The pool is
